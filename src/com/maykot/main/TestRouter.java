...
public class TestRouter {
	...
	public static void showMenu() {
		...
		case 1:
			try {
				...
				Router.getInstance().sendMessage(MainApp.myDevice, MainApp.remoteDevice, MessageParameter.SEND_TXT_FILE,
						dataToSend);
	...
	public static void sendTestHttpPost() {
		...
		try {
			Router.getInstance().sendMessage(MainApp.myDevice, MainApp.remoteDevice, MessageParameter.SEND_HTTP_POST,
					dataToSend);
		} catch (TimeoutException e) {
			System.out.println(
					"Erro " + ErrorMessage.TIMEOUT_ERROR.value() + ": " + ErrorMessage.TIMEOUT_ERROR.description());
